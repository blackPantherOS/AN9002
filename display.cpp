...
Display::Display(QWidget *parent) : QGraphicsView(parent)
{
    ...
    renderer = new QSvgRenderer(QLatin1String(":/assets/9002-lcd.svg"));
...
//    iconItems[Icon::OneMs]        = new DisplaySegment(scene, renderer, "icon.1ms");
    ...
    unitIconItems[UnitIcon::mainMilliSeconds] = new DisplaySegment(scene, renderer, "unit.main.milliseconds");
